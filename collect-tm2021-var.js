...
var NUM_CARDS = ['13791', '32026', '31585', '62048'];
NUM_CARDS = [60264, 51030, 51349, 41223, 10624, 30087, 42311, 41344, 12294, 10340, 11370, 16405, 41225, 41682, 14330, 41221, 31088, 31123, 4154, 16260, 31495, 61808, 13477, 12329];
                            ...
                            .map((i, row) => { 
                                    ...
                                    if (odd) {
                                        cells = i < 10
                                            ...
                                            : [...(i == 11 ? $row : $row).prev().children().map(_txt_).toArray(), ...cells];
                                        }; 
                                    if (i == 0 || odd ) {
                                        if (i == 7) {
                                            cells = $row.children().map(_txt_).toArray();
                                        } else if (i == 9) {
                                            cells = [...$row.prev().children().map(_txt_).toArray(), ...$row.children().map(_txt_).toArray()];
                                        }
